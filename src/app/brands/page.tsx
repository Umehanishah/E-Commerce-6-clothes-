  ...
  return (
    <main>
      ...
      {/* 1 brands */}
          <section>
            <div className="flex justify-center md:gap-20 bg-black pt-5 pb-5 px-32">
              <Image src="/group-1.png" alt="brands" width={200} height={10} />
            </div>
      ...
      {/* 2 brands */}
          <section>
            <div className="flex justify-center md:gap-20 bg-black pt-5 pb-5 px-32">
              <Image src="/group-2.png" alt="brands" width={100} height={10} />
            </div>
      ...
      {/* 3 brands */}
          <section>
            <div className="flex justify-center md:gap-20 bg-black pt-5 pb-5 px-32">
              <Image src="/group-3.png" alt="brands" width={200} height={10} />
            </div>
      ...
      {/* 4 brands */}
          <section>
            <div className="flex justify-center md:gap-20 bg-black pt-5 pb-5 px-32">
              <Image src="/group-4.png" alt="brands" width={200} height={10} />
            </div>
      ...
      {/* 5 brands */}
          <section>
            <div className="flex justify-center md:gap-20 bg-black pt-5 pb-5 px-32">
              <Image src="/group-5.png" alt="brands" width={200} height={10} />
            </div>
